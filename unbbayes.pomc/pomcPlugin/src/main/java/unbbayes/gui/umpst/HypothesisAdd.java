...
public class HypothesisAdd extends IUMPSTPanel {
	...
	private HypothesisModel hypothesis,pai;
	...
	public void listeners(){
		...
		buttonAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if( hypothesis == null){
					HypothesisModel hypothesis = new HypothesisModel(hypothesisText.getText(),commentsText.getText(), authorText.getText(), dateText.getText(),null);
					try {
