...
public class LoaderPrOwlIOTest extends TestCase {
	...
	public static final String STARSHIP16FILEEXAMPLE = "src/test/resources/mebn/StarTrek.owl"; 
	public static final String STARSHIP16FILEEXAMPLESAVED = "src/test/resources/mebn/StarTrek_result.owl"; 
