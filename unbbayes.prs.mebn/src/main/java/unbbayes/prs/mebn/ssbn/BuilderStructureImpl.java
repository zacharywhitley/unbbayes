...
//		}
	...
	private  SimpleSSBNNode createRecursiveParents(SimpleSSBNNode node,
		...
		if(prev != null){
			...
			/*
			 * Nota: uma pequena restriÃ§Ã£o aqui (fÃ¡cil de ser retirada entretanto):
			 * Consideramos que o nÃ³ pai e o nÃ³ filho possuem os mesmos argumentos com 
			 * excessÃ£o do argumento recursivo. Isto mantÃ©m a compatibilidade com as 
			 * consideraÃ§Ãµes feitas no algoritmo anterior.  
			 */ 
