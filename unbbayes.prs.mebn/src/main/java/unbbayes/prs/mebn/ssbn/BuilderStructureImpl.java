...
//			throw new SSBNNodeGeneralException(e.getMessage()); 
	...
	private void evaluateNodeInMFragInstance(MFragInstance mFragInstance, SimpleSSBNNode node) 
		...
		/*
		 * Nota: como o algoritmo apenas sobe, � necess�rio continuar a avalia��o
		 * acima mesmo quando o n� for setado como um finding, pois acima dele pode
		 * ter uma query ou n� que influ�ncia a query. (Caso fosse feita a avalia��o
		 * acima e abaixo, n�o seria necess�ria esta subida, mas o algoritmo seria 
		 * mais complexo). Isto geraria um monte de n�s candidados a serem excluidos
		 * no pr�ximo passo.  
		 */
		if(exactValue!= null){
