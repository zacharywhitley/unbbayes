...
public class ConsistencyUtilities {
	...
	public static boolean hasCycle(IResidentNode origin, IResidentNode destination){
	 ...
	 * @return
	 */
	public static  boolean hasCycle(InputNode origin, IResidentNode destination){
		/*
