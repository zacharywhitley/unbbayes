...
public class KnowledgeBasePluginManager {
	...
	public void reloadPlugins() {
    	...
    	try {
    	    ...
    	    // loads the "mebn" plugin, which declares general extension points for core (including kb)
    	    PluginDescriptor core = this.getPluginManager().getRegistry().getPluginDescriptor(this.getCorePluginID());
            
    	    // load the extension point for new kb (functionalities).
			...
			Debug.println(this.getClass(), "Error filling Knowledge Base's plugins", t);
		}
