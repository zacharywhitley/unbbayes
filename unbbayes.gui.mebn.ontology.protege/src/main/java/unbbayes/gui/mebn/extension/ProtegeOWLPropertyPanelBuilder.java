 ...
 *
 */
public class ProtegeOWLPropertyPanelBuilder extends JPanel implements IMEBNEditionPanelBuilder {

	/**
	 * Default constructor must be public to enable plugin support
	 */
	public ProtegeOWLPropertyPanelBuilder() {
	...
	public JPanel buildPanel(MultiEntityBayesianNetwork mebn,
		...
		return ProtegeOWLTabPanel.newInstance(OWLPropertiesTab.class.getName(), mebn, mediator);
	}
