...
public class UpdatePessoaAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		String idPessoa = userDynaForm.getString("idPessoa");
		...
		Pessoa pessoa = pessoaDao.findById(new Short(idPessoa).shortValue());
		pessoa.setNome(nome);
		pessoa.setCpf(cpf);
