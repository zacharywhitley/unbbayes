...
<table width='100%'>
	<tr>
		<td >
			...
			<tr>
				<td align="left">
					<INPUT type="checkbox" name="selecao" value='${item.idPerfil}' onclick="habilitaSelecao();"/> 
				</td>
				<td>
					<a style='cursor:pointer;' onclick="document.forms[0].idPerfil.value='${item.idPerfil}';enviarAssinatura(2);" >${item.nome}</a>
				</td>
				<td >
					<a style='cursor:pointer;' onclick="document.forms[0].idPerfil.value='${item.idPerfil}';enviarAssinatura(2);" >${item.descricao}</a>
				</td>
			</tr>
			<%} else {%>
			<tr>
