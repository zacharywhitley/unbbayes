	...
	function enviarAssinatura(intUrl) { 
		...
		switch (intUrl) {
			case 0:
				...
				url = "${pageContext.request.contextPath}/Usuario/CreateUsuario.do";
				break;
			case 1:
...
<html:form action='Usuario/CreateUsuario.do' method="POST" >
<table width='100%'>
	<tr>
	  ...
	  <TD>
	   <TABLE class=fancy width=100% cellpadding=4>
	    <TR>
	     ...
	     <TD height=25px><html:text property="login" styleId="login" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	     <TD height=25px ><bean:message bundle="Usuario" key="controleacesso.usuario.senha" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="senha" styleId="senha" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
