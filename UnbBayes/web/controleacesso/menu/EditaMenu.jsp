...
<html:form action='Menu/UpdateMenu.do' method="POST">
<table width='100%'>
	<tr>
	  ...
	  <TD>
	   <TABLE class=fancy width=100% cellpadding=4>
	    <TR>
	     ...
	     <TD height=25px><html:text property="nome" styleId="nome" value='${menu.nome}' styleClass="textbox" size='48' maxlength="45"/></TD>
	    </TR>
	    <TR>
	    ...
	    <tr>
	     ...
	     <TD height=25px><html:text property="url" styleId="url" value='${menu.url}' styleClass="textbox" size='48' maxlength="45"/></TD>
	    </tr>
	    <tr>
	     <TD height=25px ><bean:message bundle="Menu" key="controleacesso.menu.icon" />:</TD>
	     <TD height=25px><html:text property="icon" styleId="icon" value='${menu.icon}' styleClass="textbox" size='48' maxlength="45"/></TD>
	    </tr>
	    <tr>
	     <TD height=25px ><bean:message bundle="Menu" key="controleacesso.menu.prioridade" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="prioridade" styleId="prioridade" value='${menu.prioridade}' styleClass="textbox" size='48' maxlength="3" onkeyup="cNumber('prioridade',this.value);"/></TD>
	    </tr>
	    <tr>
	     <TD height=25px ><bean:message bundle="Menu" key="controleacesso.menu.descricao" />:</TD>
	     <TD height=25px><html:textarea property='descricao' styleId="descricao" value='${menu.descricao}' styleClass='textbox' rows="4" cols="50"/></TD>
	    </tr>
	   </TABLE>
	  </TD>
	</tr>
...
<html:hidden property="idMenu" styleId="idMenu" value="${menu.idMenu}"/>
