	...
	function enviarAssinatura(intUrl) { 
		...
		switch (intUrl) {
			case 0:
				...
				url = "${pageContext.request.contextPath}/Pessoa/CreatePessoa.do";
				break;
			case 1:
...
<html:form action='Pessoa/CreatePessoa.do' method="POST" >
<table width='100%'>
	<tr>
	  ...
	  <TD>
	   <TABLE class=fancy width=100% cellpadding=4>
	    <TR>
	     ...
	     <TD height=25px><html:text property="nome" styleId="nome" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	     <TD height=25px ><bean:message bundle="Pessoa" key="pessoa.pessoa.cpf" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="cpf" styleId="cpf" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	    ...
	    <TR>
	     ...
	     <TD height=25px><html:text property="telefoneRes" styleId="telefoneRes" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	     <TD height=25px ><bean:message bundle="Pessoa" key="pessoa.pessoa.celular" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="celular" styleId="celular" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	     <TD height=25px ><bean:message bundle="Pessoa" key="pessoa.pessoa.telefoneCom" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="telefoneCom" styleId="telefoneCom" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <TR>
	     <TD height=25px ><bean:message bundle="Pessoa" key="pessoa.pessoa.email" />:<span class=requiredfield>*</span></TD>
	     <TD height=25px><html:text property="email" styleId="email" value='' styleClass="textbox" size='48' maxlength="20"/></TD>
	    </TR>
	    <tr>
