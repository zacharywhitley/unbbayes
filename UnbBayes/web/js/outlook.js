...
function b_writeStyle() {
  ...
  document.write(' font-size:12pt; cursor:hand; border-width:1;');
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      document.write('<Layer name='+this.name+'_panel'+i+' background=\''+this.bgimage+'\' width='+this.width);
       ...
       document.write('width=16 height=16 src='+window.contexto+'/images/arrowup.gif border=0>');
       ...
       document.write('src='+window.contexto+'/images/arrowdown.gif border=0></A></LAYER>');
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      document.write('<img width=16 height=16 src='+window.contexto+'/images/arrowup.gif border=0>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src='+window.contexto+'/images/arrowdown.gif border=0>');
      document.write('</A></DIV>');
