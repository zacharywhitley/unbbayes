 ...
 *
 */
public class AggregateFunctionMinTest extends TestCase {

	// object to test
	private AggregateFunctionMin aggregateFunctionToTest;
	
	/**
	 * @param name
	 */
	public AggregateFunctionMinTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		super.setUp();
		this.aggregateFunctionToTest = AggregateFunctionMin.newInstance(null);
	}
	...
	/**
	 * Test method for {@link AggregateFunctionMin#evaluate(java.util.Collection)}
	 */
	public final void testEvaluate() {
		...
		assertEquals("Value must be the min", "true", ret.getValue());
		...
		ret = this.aggregateFunctionToTest.evaluate(inputs);
		assertNotNull("It must not return null.", ret);
		assertEquals("Value must be the min", "false", ret.getValue());
