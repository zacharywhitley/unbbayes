...
/* This file was generated by UnBBayes-PRM plugin on Sat Sep 04 16:12:37 BRT 2010 */
...
CREATE TABLE "AUX_isExpectedAt_isAgentOf" (
	 "id" 	 VARCHAR2(300) 	 not null,
	 "agentLocation_id" 	 VARCHAR2(300) 	 not null,
	 "agentAttackPlan_id" 	 VARCHAR2(300) 	 not null,
	 "isExpectedAt" 	 VARCHAR2(300) 	 
);
ALTER TABLE "AUX_isExpectedAt_isAgentOf" ADD CONSTRAINT PK_AUXISEXPECTEDATISAGENTOF PRIMARY KEY ("id");
ALTER TABLE "AUX_isExpectedAt_isAgentOf" ADD CONSTRAINT CK_isExpectedAt CHECK ( "isExpectedAt" IN ('true', 'false'));

ALTER TABLE "AUX_isExpectedAt_isAgentOf" ADD CONSTRAINT FK_AUXISEXPECTEDATISAGENTOF_AGENTLOCATION FOREIGN KEY ("agentLocation_id")  REFERENCES "AgentLocation" ("id");

ALTER TABLE "AUX_isExpectedAt_isAgentOf" ADD CONSTRAINT FK_AUXISEXPECTEDATISAGENTOF_AGENTATTACKPLAN FOREIGN KEY ("agentAttackPlan_id")  REFERENCES "AgentAttackPlan" ("id");
...
COMMENT ON COLUMN AgentAttackPlan.isAgentOf IS 'PrsnOfIntrst.isWeaponSupplier()[ FK_AGENTATTACKPLAN_AGENT ] , AttackPlan.isActivePlan()[ FK_AGENTATTACKPLAN_PLAN ] , AUX_isExpectedAt_isAgentOf.isExpectedAt(Mode)[ !FK_AUXISEXPECTEDATISAGENTOF_AGENTATTACKPLAN ] , AUX_SNRival_isAgentOf.SNRival(Mode)[ !FK_AUXSNRIVALISAGENTOF_AGENTATTACKPLAN ] ;  { 0.75 0.25 0.02 0.98 0.0 1.0 0.0 1.0 0.05 0.95 0.0050 0.995 0.0 1.0 0.0 1.0 0.05 95.0 0.0050 0.995 0.05 0.95 0.0 1.0 0.05 0.95 0.0050 0.995 0.0 1.0 0.0 1.0 }';
...
COMMENT ON COLUMN AUX_isExpectedAt_isAgentOf.isExpectedAt IS 'AgentLocation.isExpectedAt()[ FK_AUXISEXPECTEDATISAGENTOF_AGENTLOCATION ] ;  { 1.0 0.0 0.0 1.0 }';
...
INSERT INTO "AttackPlanTarget" (id, isTarget, venue_id, attackPlan_id) VALUES (NULL, NULL, 'ResC', 'ConfAtk');
INSERT INTO "AttackPlanTarget" (id, isTarget, venue_id, attackPlan_id) VALUES (NULL, NULL, 'Conf', 'ConfAtk');
INSERT INTO "AttackPlanTarget" (id, isTarget, venue_id, attackPlan_id) VALUES (NULL, NULL, 'Conf', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('V', '0', NULL, 'C', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('AD', '1', NULL, 'C', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('P', '2', NULL, 'C', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('TL6', '3', NULL, 'C', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('C', '4', NULL, 'V', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('AD', '5', NULL, 'V', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('P', '6', NULL, 'V', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('TL6', '7', NULL, 'V', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('V', '8', NULL, 'AD', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('C', '9', NULL, 'AD', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('P', '10', NULL, 'AD', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('TL6', '11', NULL, 'AD', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('V', '12', NULL, 'P', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('C', '13', NULL, 'P', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('TL6', '14', NULL, 'P', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('AD', '15', NULL, 'P', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('V', '16', NULL, 'TL6', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('C', '17', NULL, 'TL6', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('P', '18', NULL, 'TL6', NULL);
INSERT INTO "SocialNetwork" (agt1, id, SNRelated, agt2, SNRival) VALUES ('AD', '19', NULL, 'TL6', NULL);
