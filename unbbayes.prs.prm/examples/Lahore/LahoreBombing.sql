...
/* This file was generated by UnBBayes-PRM plugin on Sun Sep 05 11:52:44 BRT 2010 */
...
ALTER TABLE "AUX_SocialNetwork_AgentAttackPlan" ADD CONSTRAINT FK_AUXSNRIVALISAGENTOF_AGENTATTACKPLAN FOREIGN KEY ("agentAttackPlan_id")  REFERENCES "AgentAttackPlan" ("id");
...
COMMENT ON COLUMN PrsnOfIntrst.explosiveResidueReport IS 'PlanExecution.PlantsExplosives(Mode)[ !FK_PLANEXECUTION_AGENT ] ;  { 0.8 0.2 5.0E-4 0.9995 }';
...
COMMENT ON COLUMN AgentAttackPlan.isAgentOf IS 'PrsnOfIntrst.isWeaponSupplier()[ FK_AGENTATTACKPLAN_AGENT ] , AttackPlan.isActivePlan()[ FK_AGENTATTACKPLAN_PLAN ] , AUX_AgentLocation_AgentAttackPlan.isExpectedAt(Mode)[ !FK_AUXISEXPECTEDATISAGENTOF_AGENTATTACKPLAN ] , AUX_SocialNetwork_AgentAttackPlan.SNRival(Mode)[ !FK_AUXSNRIVALISAGENTOF_AGENTATTACKPLAN ] ;  { 0.75 0.25 0.02 0.98 0.0 1.0 0.0 1.0 0.05 0.95 0.0050 0.995 0.0 1.0 0.0 1.0 0.05 95.0 0.0050 0.995 0.05 0.95 0.0 1.0 0.05 0.95 0.0050 0.995 0.0 1.0 0.0 1.0 }';
