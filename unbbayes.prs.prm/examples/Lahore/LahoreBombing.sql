...
/* This file was generated by UnBBayes-PRM plugin on Sat Sep 04 13:10:39 BRT 2010 */
...
ALTER TABLE "AttackPlanTarget" ADD CONSTRAINT PK_Rel_AttackPlan_Venue PRIMARY KEY ();
...
ALTER TABLE "AgentAttackPlan" ADD CONSTRAINT PK_Rel_PrsnOfIntrst_AttackPlan PRIMARY KEY ();
...
ALTER TABLE "LocationReport" ADD CONSTRAINT PK_NewPRMEntity1 PRIMARY KEY ();
...
ALTER TABLE "SocialNetwork" ADD CONSTRAINT PK_NewPRMEntity2 PRIMARY KEY ();
...
ALTER TABLE "AgentLocation" ADD CONSTRAINT PK_NewPRMEntity3 PRIMARY KEY ();
...
ALTER TABLE "MeetingVenue" ADD CONSTRAINT PK_NewPRMEntity4 PRIMARY KEY ();
...
ALTER TABLE "PlanExecution" ADD CONSTRAINT PK_NewPRMEntity5 PRIMARY KEY ();
...
COMMENT ON COLUMN AgentAttackPlan.isAgentOf IS ' ;  { 1.0 0.0 }';
...
INSERT INTO "PrsnOfIntrst" (isWeaponSupplier, id) VALUES (NULL, 'V');
INSERT INTO "PrsnOfIntrst" (isWeaponSupplier, id) VALUES (NULL, 'C');
INSERT INTO "PrsnOfIntrst" (isWeaponSupplier, id) VALUES (NULL, 'AD');
INSERT INTO "PrsnOfIntrst" (isWeaponSupplier, id) VALUES (NULL, 'P');
INSERT INTO "PrsnOfIntrst" (isWeaponSupplier, id) VALUES (NULL, 'TL6');
