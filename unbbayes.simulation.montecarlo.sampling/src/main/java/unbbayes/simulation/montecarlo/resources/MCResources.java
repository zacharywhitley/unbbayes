...
public class MCResources extends ListResourceBundle {
	...
	{	
		...
		{"sampleSizeException", "The sample size must be an integer greater than zero"},
		{"saveException", "Error while saving file with sampled states"},
		{"saveSuccess", "File with sampled states saved successfully"},


		{"selectFile", "You must select a file to start sampling. "},
		{"openFile", "Open network file for sampling"},
