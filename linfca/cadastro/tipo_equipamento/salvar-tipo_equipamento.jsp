...
<%
	String nomeTabela = "tipo_equipamento";
...
<br>
	  ...
	  <tr>
		<td>
		        <INPUT maxLength=30 name="string_desc_tipo_equipamento"
				 value="<% if (elementoXML != null) { %><%=elementoXML.getChildTextTrim("desc_tipo_equipamento")%><% } %>">
		</td>
	  </tr>
	  <INPUT type="hidden" name="nome_tabela" value="<%=nomeTabela%>">
	  <% if (elementoXML != null) { %>
			<INPUT type="hidden" name="int_cod_tipo_equipamento" value="<%=codElemento%>">
	  <% } %>
	  <tr>
		<td colspan=2>
