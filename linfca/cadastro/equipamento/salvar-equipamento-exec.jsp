...
<%
   ...
   Element in = new Element("equipamento");
   ...
   while (params.hasMoreElements()) {
	  ...
	  if (name.equals("int_cod_equipamento")) {
	     inserir = false;
   ...
   if (saida.getChild("ok") != null) {
      mensagem = (inserir) ? "O equipamento foi incluído com sucesso!"
	   						: "Os dados do equipamento foram alterados com sucesso!";	
   } else {
