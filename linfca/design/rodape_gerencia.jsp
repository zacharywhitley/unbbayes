  ...
  <tr>
    <td height="40" colspan="2" align="center" bgcolor="#336633" valign="middle">
      ...
      <span style="font-size: 13px">
        <a href="<%=path%>/cadastro/curso/selecionar-curso.jsp">curso</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/sala/selecionar-sala.jsp">equipamento</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/equipamento/selecionar-equipamento.jsp">sala</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/semestre/selecionar-semestre.jsp">semestre</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/tipo_equipamento/selecionar-tipo_equipamento.jsp">tipo equipamento</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/tipo_sexo/selecionar-tipo_sexo.jsp">tipo sexo</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
        <a href="<%=path%>/cadastro/tipo_usuario/selecionar-tipo_usuario.jsp">tipo usuário</a>&nbsp;&nbsp;|&nbsp;&nbsp; 
