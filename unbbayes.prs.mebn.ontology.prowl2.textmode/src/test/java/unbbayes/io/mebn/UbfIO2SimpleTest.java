...
public class UbfIO2SimpleTest extends TestCase {


	public UbfIO2SimpleTest(String name) {
		super(name);
	}
	...
	public static Test suite() {
		TestSuite suite = new TestSuite(UbfIO2SimpleTest.class.getName());
		//$JUnit-BEGIN$
		suite.addTestSuite(UbfIO2SimpleTest.class);
		//$JUnit-END$
		return suite;
	}
