...
//					|| !argumentIndividual.getTypes(ontology).contains(mappingArgumentClass)
	 ...
	 */
	protected void setOntologyPrefixCache(Map<OWLOntology, PrefixManager> ontologyPrefixCache) {
	 ...
	 * @see unbbayes.io.mebn.prowl2.owlapi.INonPROWLClassExtractor#getPROWLOntologyNamespaceURIs()
	 */
	...
	/**
	 * Simply delegates to {@link #getNonPROWLClassExtractor()}
	 * @see unbbayes.io.mebn.prowl2.owlapi.INonPROWLClassExtractor#setPROWLOntologyNamespaceURIs(java.util.Collection)
	 */
