...
There are classes generated by jaxme. This classes are configured to be created in the 
\target\jaxme folder. To generate this classes in your computer just go to the folder 
where the pom.xml is located (root folder) and execute:
mvn jaxme:jaxme
