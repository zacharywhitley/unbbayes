...
public class DataManipulationResource_pt extends ListResourceBundle {
	...
	static final Object[][] contents = {
		 ...
		 * FileUtils
		 *********************************************************************/
		{"arffFilterText", "Arquivos Arff (*.arff)"},
		{"txtFilterText", "Arquivos Txt (*.txt)"},
		{"besFilterText", "Arquivos de Avaliação em Lote (*.bev)"},

		{"canceledDialog", "Cancelado pelo usuário"},

		/* Bev file */
		{"openBevDialog", "Abrir arquivo Bev"},
		{"saveBevDialog", "Salvar arquivo Bev"},
		{"openBevSuccess", "Arquivo Bev aberto com sucesso"},
		{"saveBevSuccess", "Arquivo Bev salvo com sucesso"},
		
		/* Arff file */
		{"openArffDialog", "Abrir arquivo Arff"},
		{"saveArffDialog", "Salvar arquivo Arff"},
		{"openArffSuccess", "Arquivo Arff aberto com sucesso"},
		{"saveArffSuccess", "Arquivo Arff salvo com sucesso"},
		
		/* Txt file */
		{"openTxtDialog", "Abrir arquivo Txt"},
		{"saveTxtDialog", "Salvar arquivo Txt"},
		{"openTxtSuccess", "Arquivo Txt aberto com sucesso"},
		{"saveTxtSuccess", "Arquivo Txt salvo com sucesso"},
