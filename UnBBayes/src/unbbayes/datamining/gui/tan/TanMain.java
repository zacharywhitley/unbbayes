package unbbayes.datamining.gui.tan;
...
public class TanMain extends JInternalFrame
{
  ...
  /**Construct the frame*/
  public TanMain()
  { super("TAN Classifier",true,true,true,true);
  ...
  {   setCursor(new Cursor(Cursor.WAIT_CURSOR));
      ...
      fileChooser.setMultiSelectionEnabled(false);
      //adicionar FileView no FileChooser para desenhar ícones de arquivos
      fileChooser.setFileView(new FileIcon(TanMain.this));
