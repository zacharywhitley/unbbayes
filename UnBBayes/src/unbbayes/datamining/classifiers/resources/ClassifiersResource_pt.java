...
{	
	...
	*/
	...
	{	// Naive Bayes
		...
		{"exception1","Não é aceito classe num�rica!"},
		{"attribute","Atributo"},
		{"exception2","menos do que duas classes"},
		{"exception3","o desvio padrão é 0 para a classe"},
		{"exception4","o modelo ainda não foi constru�do"},
		{"class","Classe"},
		{"mean","Média"},
		{"stdev","Desvio padrão:"},
		...
		{"classNegative","�ndice da classe � negativo (não definido)!"},
		{"noMatrix","Avaliação: A matriz confusão não pode ser construída!"},
		{"accuracy","=== Acurácia Detalhada por Classe ===\n"},
		{"matrix","=== Matriz Confusão ===\n"},
		// Id3
		{ "exception1","�rvore de decis�o: Não é aceito classe numérica!"		},
		{ "exception2","�rvore de decis�o: Não é aceito atributos numéricos!"	},
		{ "exception3","�rvore de decis�o: Não são aceitos missing values!" 	},
		{ "toStringException1","�rvore de decis�o: O modelo ainda não foi construído. Tente de novo!"	},
