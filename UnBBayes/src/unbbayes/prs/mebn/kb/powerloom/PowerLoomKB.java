 ...
 * contexto. O PowerLoom ? utilizado como um reasoner de Lógica de primeira
 * ordem. 
 * 
...
public class PowerLoomKB implements KnowledgeBase{
	 ...
	 * Usaremos deste ultimo fato para definir o que ? uma variável ordinária
	 * e o que ? uma variável exemplar: sempre que a variável ordinária não 
