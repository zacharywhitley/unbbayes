...
public class JunctionTree {
    ...
    protected void absorve(Clique clique1, Clique clique2) {
        ...
        PotentialTable originalSeparatorTable = (PotentialTable) separator.getPotentialTable().clone();
        ...
        dummyTable.directOpTab(originalSeparatorTable, PotentialTable.DIVISION_OPERATOR);
    ...
    */
    ...
    private void calcularCoordenadasMulti() {
        ...
        for (int i = 0; i < sizeSeparadores; i++) {
            ...
            coordSep[i] = new int[aux.getPotentialTable().tableSize()][aux.getPotentialTable().variableCount()];
