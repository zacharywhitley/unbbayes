...
/**
 * Janela para discretiza��o m�ltipla
 * 
...
public class janeladiscret extends JFrame {
	...
	private JPanel getJPanel() {
		if (jPanel == null) {
			jLabel1 = new JLabel();
			jLabel1.setText("Tipo de discretiza��o");
			jLabel = new JLabel();
			jLabel.setText("Vari�vel dependente");
			jPanel = new JPanel();
			jPanel
	...
	private JComboBox getDiscretlist() {
		if (discretlist == null) {
			...
			discretlist
					.setToolTipText("Escolha o tipo de discretiza��o a ser aplicada");
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			jLabel2 = new JLabel();
			jLabel2.setText("Aceitar perda de at�");
			jPanel2 = new JPanel();
