 ...
 *@see        JPanel
 */
public class IGraph_pt extends JPanel implements MouseListener, MouseMotionListener {
     ...
     */
    public IGraph_pt(WindowController _controller, JViewport _graphViewport) {
        super();
		this.controller = _controller;
		this.graphViewport = _graphViewport;
