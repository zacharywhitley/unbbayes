...
public class FronteiraResources extends ListResourceBundle {
	...
	{	{"fileDirectoryType","Directory"},
		...
		{"netLabel","Net"},
		{"netToolTip","Net size"},
		{"probabilisticNodeColorLabel","Probabilistic Node Color"},
		{"probabilisticNodeColorToolTip","Select probabilistic node color"},
		{"decisionNodeColorLabel","Decision Node Color"},
		{"decisionNodeColorToolTip","Select decision node color"},
		{"utilityNodeColorLabel","Utility Node Color"},
		{"utilityNodeColorToolTip","Select utility node color"},
		{"nodeColorLabel","Node Color"},
		{"arcColorLabel","Arc Color"},
