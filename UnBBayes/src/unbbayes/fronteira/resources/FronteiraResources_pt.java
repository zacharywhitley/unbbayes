...
public class FronteiraResources_pt extends ListResourceBundle {
	...
	{	{"fileDirectoryType","Diretório"},
		...
		{"probabilisticNodeColorLabel","Cor do Nó de Probabilidade"},
		{"probabilisticNodeColorToolTip","Selecionar a cor do nó de probabilidade"},
		{"decisionNodeColorLabel","Cor do Nó de Decisão"},
		{"decisionNodeColorToolTip","Selecionar a cor do nó de decisão"},
		{"utilityNodeColorLabel","Cor do Nó de Utilidade"},
		...
		{"selectionColorLabel","Cor de Seleção"},
