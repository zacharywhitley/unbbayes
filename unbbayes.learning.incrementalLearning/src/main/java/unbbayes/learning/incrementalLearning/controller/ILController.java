 ...
 *
 */
package unbbayes.learning.incrementalLearning.controller;

import java.util.ArrayList;
import java.util.List;

import unbbayes.learning.incrementalLearning.util.ILToolkit;
...
public class ILController extends ILToolkit {
    ...
    private boolean isEquivalente(Object[] fronteira, Node node){
        ...
        double confianca = ChiSquareTable.getArea(numeroCelulas - 1,0.05);
