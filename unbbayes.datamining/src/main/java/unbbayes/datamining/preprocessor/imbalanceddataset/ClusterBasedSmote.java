 ...
 * @date 09/11/2006
 */
public class ClusterBasedSmote extends Batch {
	...
	public ClusterBasedSmote(InstanceSet instanceSet,
		...
		preprocessorName = "Cluster Based Smote";
	}

	public ClusterBasedSmote(ClusterBasedUtils clusterBasedUtils,
	...
	public ClusterBasedSmote(InstanceSet instanceSet) throws Exception {
		this(instanceSet, null);
		setClusterInfo(null);
	}
	...
	private void initializeClusters() throws Exception {
		...
		smoteNN = clusterBasedUtils.getSmoteNNByClass(k);
	}
	...
	private void smoteCluster(int clusterID, double proportion,
