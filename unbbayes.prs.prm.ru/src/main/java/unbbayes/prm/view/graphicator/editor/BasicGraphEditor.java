...
public abstract class BasicGraphEditor extends JPanel {
	...
	private static final int PALETE_WIDTH = 200;
	/**
     *
     */
     ...
     *
     */
	public void initGraphEditor(String appTitle, mxGraphComponent component) {
		...
		outerSplit = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, inner,
				graphComponent);
	...
	public EditorPalette insertPalette(String title) {
		...
		// Move splitter
		outerSplit.setDividerLocation(PALETE_WIDTH);
...
//
//				if (cell != null) {
//					selectedCell( graphComponent.getGraph().getLabel(cell));
//				}
//
//			
//			}
