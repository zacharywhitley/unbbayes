...
<If you do not have unbbayes.simulation.montecarlo.sampling in your local mvn repository, then execute the below command>
Go to \mvn_lib\unbbayes>
mvn install:install-file -DgroupId=br.unb.cic -DartifactId=unbbayes.simulation.montecarlo.sampling -Dversion=1.1.0 -Dpackaging=jar -Dfile=unbbayes.simulation.montecarlo.sampling-1.1.0.jar
