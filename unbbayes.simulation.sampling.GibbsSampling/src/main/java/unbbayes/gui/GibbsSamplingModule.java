 ...
 *
 */
public class GibbsSamplingModule extends UnBBayesModule implements UnBBayesModuleBuilder {
	
	private static final long serialVersionUID = 1L;

	private String name = "Gibbs Sampling";
	...
	public void setUnbbayesFrame(UnBBayesFrame unbbayesFrame) {
		...
		try {
			lastBuiltMcMainController = new MCMainController(new GibbsSampling());
		} catch (Throwable t) {
			t.printStackTrace();
		}
