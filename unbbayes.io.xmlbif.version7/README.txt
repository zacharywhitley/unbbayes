...
mvn install:install-file -DgroupId=edu.gmu.seor -DartifactId=prognos.unbbayesplugin.cps -Dversion=1.5 -Dpackaging=jar -Dfile=prognos.unbbayesplugin.cps-1.0.0.jar
