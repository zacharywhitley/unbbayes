...
import unbbayes.io.xmlbif.version7.xmlclasses.ObjectFactory;
import unbbayes.io.xmlbif.version7.xmlclasses.XMLBIF;
import unbbayes.io.xmlbif.version7.xmlclasses.XMLBIFType;
...
public class XMLBIFIO {
	...
	public static void loadXML(File input, SingleEntityNetwork pn) throws LoadException, IOException, JAXBException{
		...
		unmarshaller.setValidating(true);
			...
			// class that has all scripts for all nodes from the CPS plugin
			...
			for(int i = 0; i < distributionList.size(); i++){
				...
				XMLBIFType.NetworkType.ConditionalDistributionSetType.ConditionalDistributionType.CPSType cps = distribution.getCPS();
