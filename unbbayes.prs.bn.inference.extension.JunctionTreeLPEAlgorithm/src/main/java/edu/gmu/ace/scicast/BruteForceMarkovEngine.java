...
public class BruteForceMarkovEngine extends MarkovEngineImpl {
	...
	/*
	 * (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#getProbLists(java.util.List, java.util.List, java.util.List, boolean, unbbayes.prs.bn.ProbabilisticNetwork, boolean)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#getAssetsIfStates(long, java.util.List, java.util.List, unbbayes.prs.bn.inference.extension.AssetAwareInferenceAlgorithm, boolean, unbbayes.prs.bn.Clique)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#addNetworkAction(long, edu.gmu.ace.scicast.NetworkAction)
	 */
	...
	public class JointProbabilityAndAssetTablesMemento extends ProbabilityAndAssetTablesMemento {
		...
		/**
		 * @see edu.gmu.ace.scicast.MarkovEngineImpl.ProbabilityAndAssetTablesMemento#restore()
		 */
		...
		/* (non-Javadoc)
		 * @see edu.gmu.ace.scicast.MarkovEngineImpl.ProbabilityAndAssetTablesMemento#getProbTableMap()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see edu.gmu.ace.scicast.MarkovEngineImpl.ProbabilityAndAssetTablesMemento#getAssetTableMap()
		 */
		@Override
	...
	/* (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#getMemento()
	 */
	@Override
	...
	public class BruteForceRevertTradeNetworkAction extends RevertTradeNetworkAction{
		...
		/* (non-Javadoc)
		 * @see edu.gmu.ace.scicast.MarkovEngineImpl.RebuildNetworkAction#execute()
		 */
		@Override
		public void execute() {
		...
		/* (non-Javadoc)
		 * @see edu.gmu.ace.scicast.MarkovEngineImpl.RebuildNetworkAction#isToExecuteAction(edu.gmu.ace.scicast.NetworkAction)
		 */
	...
	/* (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#revertTrade(java.lang.Long, java.util.Date, java.util.Date, java.lang.Long)
	 */
...
//							getDefaultInferenceAlgorithm().setAsPermanentEvidence(node, getSettledState(), isToDeleteResolvedNode());
	...
	/*
	 * (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#resolveQuestion(java.lang.Long, java.util.Date, long, int)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#doBalanceTrade(java.lang.Long, java.util.Date, java.lang.String, long, long, java.util.List, java.util.List)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.gmu.ace.scicast.MarkovEngineImpl#previewBalancingTrade(long, long, java.util.List, java.util.List)
	 */
	@Override
