 ...
 */
public interface LocalModelHome extends EJBLocalHome {

	public LocalModel create(
		int id,
		String name,
		String definition,
		String description)
	...
	public LocalModel findByPrimaryKey(int id) throws FinderException;

	public Collection findByDomain(int domainId) throws FinderException;

	public LocalModel findByEvidence(int evidenceId) throws FinderException;
